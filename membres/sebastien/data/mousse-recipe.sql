...
INSERT INTO `comment`(`recipe_id`, `user_name`, `subject`,`comment`, `created_date`, `stars`)
VALUES(@recipe_id, "seb", "chocomous","cannibalisme!!!", NULL, 1),
(@recipe_id, "seb","chocomouse", "délicieux!!!", NULL, 5);
