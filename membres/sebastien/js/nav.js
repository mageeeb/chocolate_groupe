...
$(function () {
  ...
  function fixNav(firstTime) {
    if (!scrollNav && window.scrollY > $(".header-text").height() + 100) {
      ...
      scrollNav &&
      window.scrollY <= $(".header-text").height() + 100
    ) {
      scrollNav = false;
  ...
  $("#nav-recipes")
    ...
    .each(function (i) {
      ...
      switch (i) {
        ...
        case 2:
          url =
            basePath + "fondant au chocolat/1575898110_fondant-au-chocolat.jpg";
          break;
        case 3:
        ...
        case 4:
          url =
            basePath +
            "cookies chocolat/13370901-Cookies-with-chocolate-chips-and-almonds-on-baking-sheet.jpg";
          break;
        case 5:
        ...
        case 6:
          url =
            basePath +
            "Bûche de Noël chocolat/14175853-Bûche-de-Noël-made-from-chocolate-sponge-cake-with-quark-filling.jpg";
          break;
        case 7:
          url =
            basePath + "Moelleux chocolat/histoire_moelleux_au_chocolat.webp";
          break;
        case 8:
          url =
            basePath +
            "Truffes au chocolat/front-view-composition-delicious-chocolate-goodies.jpg";
          break;
        case 9:
          url =
            basePath +
            "macarons au chocolat/0a80c4a2-8ce0-4491-a5e8-e903fdb1fafd_eyqtYhH.jpg";
          break;
      }
      $(this).on("mouseover", () => {
